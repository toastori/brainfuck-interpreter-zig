...
pub inline fn vsprintf(arg___stream: [*c]u8, arg___format: [*c]const u8, arg___local_argv: __builtin_va_list) c_int {
...
pub inline fn vsnprintf(arg___stream: [*c]u8, arg___n: c_ulonglong, arg___format: [*c]const u8, arg___local_argv: __builtin_va_list) c_int {
    var __stream = arg___stream;
    _ = &__stream;
    var __n = arg___n;
    _ = &__n;
...
pub const __mingw_bos_declare = @compileError("unable to translate macro: undefined identifier `__noreturn__`"); // C:\Program Files\Zig\zigup\zig\0.13.0-dev.351+64ef45eb0\files\lib\libc\include\any-windows-any/_mingw_mac.h:335:11
pub const __mingw_bos_ovr = @compileError("unable to translate macro: undefined identifier `__always_inline__`"); // C:\Program Files\Zig\zigup\zig\0.13.0-dev.351+64ef45eb0\files\lib\libc\include\any-windows-any/_mingw_mac.h:361:11
pub const __mingw_bos_extern_ovr = @compileError("unable to translate macro: undefined identifier `__always_inline__`"); // C:\Program Files\Zig\zigup\zig\0.13.0-dev.351+64ef45eb0\files\lib\libc\include\any-windows-any/_mingw_mac.h:364:11
